...
public:
  ...
  // Retorna true se IdOrig eh uma id valida para a origem do sinal de uma entrada de porta ouo
  ...
  // Se der tudo certo, retorna true. Se algum parametro for invalido, retorna false.
  bool setIdOutput(int IdOut, int IdOrig);
  ...
  // Soh deve imprimir se o circuito for valido.
